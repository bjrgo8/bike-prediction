...
class Inference:
    ...
    def users_input(self):
        ...
        seasons=input('season (Autmn,Spring,Summer,Winter): ')
        ...
        u_input_list = [hour,temperature,humidity,wind_speed,visibility,solar_radiation,rainfall,snowfall,holiday_dic[holiday],finctioning_day[functioning_day],str_to_date['day'],str_to_date['month'],str_to_date['year']]
...
if  __name__=="__main__":
    ml_model_path=r"D:\bike prediction\MODELS\xgboost_regressor_r2_0_936_v1.pkl"
    standard_scaler_path=r"D:\bike prediction\MODELS\sc.pkl"
    inference= Inference( ml_model_path,standard_scaler_path)

    pred=inference.prediction()
    print(f"Rented Bike Count prediction with respect to date and Time is: {round(pred.tolist()[0])}")
